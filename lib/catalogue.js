...
export const GROUPS = [
  {
    ...
    pages: [
      ...
      { slug: "iphone-17", title: "iPhone 17, Pro, Max", models: ["iPhone 17", "iPhone 17 Pro", "iPhone 17 Pro Max", "iPhone Gloryhole Case"] },
      { slug: "iphone-e", title: "iPhone 16e, 17e", models: ["iPhone 16e", "iPhone 17e", "iPhone Gloryhole Case"] },
      { slug: "iphone-16", title: "iPhone 16, Plus, Pro, Max", models: ["iPhone 16", "iPhone 16 Plus", "iPhone 16 Pro", "iPhone 16 Pro Max"] },
      { slug: "iphone-15", title: "iPhone 15, Plus, Pro, Max", models: ["iPhone 15", "iPhone 15 Plus", "iPhone 15 Pro", "iPhone 15 Pro Max"] },
      { slug: "iphone-14", title: "iPhone 14, Plus, Pro, Max", models: ["iPhone 14", "iPhone 14 Plus", "iPhone 14 Pro", "iPhone 14 Pro Max"] },
      { slug: "iphone-13", title: "iPhone 13, mini, Pro, Max", models: ["iPhone 13", "iPhone 13 mini", "iPhone 13 Pro", "iPhone 13 Pro Max"] },
      { slug: "iphone-12", title: "iPhone 12, mini, Pro, Max", models: ["iPhone 12 & 12 Pro", "iPhone 12 mini", "iPhone 12 Pro Max"] },
      { slug: "iphone-11", title: "iPhone 11 Pro, Max", models: ["iPhone 11 Pro", "iPhone 11 Pro Max"] },
      { slug: "iphone-xr", title: "iPhone XR & 11", models: ["iPhone XR", "iPhone 11"] },
      { slug: "iphone-x", title: "iPhone X & Xs", models: ["iPhone X", "iPhone XS", "iPhone XS Max"] },
      { slug: "iphone-7", title: "iPhone 7, 8, Plus & SE", models: ["iPhone 7-8", "iPhone 7-8 Plus"] },
      { slug: "iphone-6", title: "iPhone 6, 6s, Plus", models: ["iPhone 6-6s", "iPhone 6-6s Plus"] },
  ...
  },
  {
    ...
    pages: [
      { slug: "ipad-pro-2024", title: "iPad Pro M4 / M5", models: ["iPad Pro 11 M4", "iPad Pro 13 M4"] },
      { slug: "ipad-air-2020", title: "iPad Air / Pro (2018)", models: ["iPad Air 11-inch", "iPad Air 13-inch"] },
      { slug: "ipad-10", title: "Liquid iPad", models: ["iPad 10"] },
      { slug: "ipad-mini-6", title: "Liquid iPad mini", models: ["iPad mini 6"] },
      { slug: "ipad-pro-2020", title: "iPad Pro A12Z / M1 / M2", models: ["iPad Pro 11 M1", "iPad Pro 12.9 M1"] },
      ...
      { slug: "ipad-air-2013", title: "iPad Air 1–2 & iPad 5–6", models: ["iPad Air 2", "iPad 9.7", "iPad 9.7 thicc"] },
  ...
  },
  {
    ...
    pages: [
      ...
      { slug: "macbook", title: "MacBook Leather Sleeve", models: ["MacBook 12", "MacBook Pro 13", "MacBook Pro 15", "MacBook Pro 16"] },
...
export function getPageSections(page) {
  ...
  for (const row of rows()) {
    ...
    if (!bucket) {
      bucket = { kind: row.kind, cases: [], prices: { USD: new Set(), EUR: new Set(), GBP: new Set() } };
      byKind.set(row.kind, bucket);
    }
    bucket.cases.push(row);
    const usd = asAmount(row.MSRP);
    const eur = asAmount(row.MSRP_EUR);
    const gbp = asAmount(row.MSRP_GBP);
    if (usd) bucket.prices.USD.add(usd);
    if (eur) bucket.prices.EUR.add(eur);
    if (gbp) bucket.prices.GBP.add(gbp);
  }
