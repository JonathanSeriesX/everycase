...
<Tabs items={['Pencil 1', 'Pencil 2', 'Pencil (USB-C)']}>
...
| ------------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| Taupe         | MPQL2<wbr/>ZM/A | <Link href="/case/MPQL2"><img src="https://cloudfront.everycase.org/everypreview/MPQL2_cut.webp" alt="Taupe Leather Case"/></Link>         |
| Saddle Brown  | MQ0V2<wbr/>ZM/A | <Link href="/case/MQ0V2"><img src="https://cloudfront.everycase.org/everypreview/MQ0V2_cut.webp" alt="Saddle Brown Leather Case"/></Link>  |
| Midnight Blue | MQ0W2<wbr/>ZM/A | <Link href="/case/MQ0W2"><img src="https://cloudfront.everycase.org/everypreview/MQ0W2_cut.webp" alt="Midnight Blue Leather Case"/></Link> |
| Black         | MQ0X2<wbr/>ZM/A | <Link href="/case/MQ0X2"><img src="https://cloudfront.everycase.org/everypreview/MQ0X2_cut.webp" alt="Black Leather Case"/></Link>         |

### Late 2017

| Color   | SKU             | Tap for more:                                                                                                                                 |
| ------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Red     | MR552<wbr/>FE/A | <Link href="/case/MR552"><img src="https://cloudfront.everycase.org/everypreview/MR552_cut.webp" alt="Red Leather Case"/></Link>     |
| Fuchsia | MR582<wbr/>FE/A | <Link href="/case/MR582"><img src="https://cloudfront.everycase.org/everypreview/MR582_cut.webp" alt="Fuchsia Leather Case"/></Link> |

### Spring 2018

| Color         | SKU             | Tap for more:                                                                                                                                       |
| ------------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| Electric Blue | MRFN2<wbr/>ZM/A | <Link href="/case/MRFN2"><img src="https://cloudfront.everycase.org/everypreview/MRFN2_cut.webp" alt="Electric Blue Leather Case"/></Link> |
| Soft Pink     | MRFP2<wbr/>ZM/A | <Link href="/case/MRFP2"><img src="https://cloudfront.everycase.org/everypreview/MRFP2_cut.webp" alt="Soft Pink Leather Case"/></Link>     |
