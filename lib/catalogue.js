...
export function getTopPage(slug) {
...
// Where a case lives in the drill-down. Returns { group, page }; group is
// null for top-level pages (their URL is /<page.slug>).
