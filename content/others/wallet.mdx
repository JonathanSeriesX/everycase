...
<PricedSections model={["MagSafe iPhone"]}>
...
<CaseTableTabs
  tabs={[
    {
      model: "MagSafe iPhone",
      material: "Leather Wallet",
    },
  ]}
/>

Autumn 2021 and later collections are [Find My compatible](https://support.apple.com/en-us/HT212733).
