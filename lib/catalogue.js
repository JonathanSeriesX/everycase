...
export const GROUPS = [
  {
    slug: "iphone",
    title: "iPhone",
    blurb: "Cases, sleeves, bumpers, wallets, socks",
    pages: [
      { slug: "iphone-air", title: "iPhone Air", models: ["iPhone Air", "iPhone Gloryhole Case"] },
      { slug: "iphone-17", title: "iPhone 17, Pro, Max", models: ["iPhone 17", "iPhone 17 Pro", "iPhone 17 Pro Max", "iPhone Gloryhole Case"], merged: ["Clear Case"] },
      { slug: "iphone-e", title: "iPhone 16e, 17e", models: ["iPhone 16e", "iPhone 17e", "iPhone Gloryhole Case"] },
      { slug: "iphone-16", title: "iPhone 16, Plus, Pro, Max", models: ["iPhone 16", "iPhone 16 Plus", "iPhone 16 Pro", "iPhone 16 Pro Max"], merged: ["Clear Case"] },
      { slug: "iphone-15", title: "iPhone 15, Plus, Pro, Max", models: ["iPhone 15", "iPhone 15 Plus", "iPhone 15 Pro", "iPhone 15 Pro Max"], merged: ["Clear Case"] },
      { slug: "iphone-14", title: "iPhone 14, Plus, Pro, Max", models: ["iPhone 14", "iPhone 14 Plus", "iPhone 14 Pro", "iPhone 14 Pro Max"], merged: ["Clear Case"] },
      { slug: "iphone-13", title: "iPhone 13, mini, Pro, Max", models: ["iPhone 13", "iPhone 13 mini", "iPhone 13 Pro", "iPhone 13 Pro Max"], merged: ["Clear Case"] },
      { slug: "iphone-12", title: "iPhone 12, mini, Pro, Max", models: ["iPhone 12 mini", "iPhone 12 & 12 Pro", "iPhone 12 Pro Max"], merged: ["Clear Case"] },
      { slug: "iphone-11", title: "iPhone 11 Pro, Max", models: ["iPhone 11 Pro", "iPhone 11 Pro Max"], merged: ["Clear Case"] },
      { slug: "iphone-xr", title: "iPhone XR & 11", models: ["iPhone XR", "iPhone 11"], merged: ["Clear Case"] },
      { slug: "iphone-x", title: "iPhone X & Xs", models: ["iPhone X", "iPhone XS", "iPhone XS Max"] },
      { slug: "iphone-7", title: "iPhone 7, 8, Plus & SE", models: ["iPhone 7-8", "iPhone 7-8 Plus"], tabLabels: { "iPhone 7-8": "iPhone 7 / 8", "iPhone 7-8 Plus": "iPhone 7 Plus / 8 Plus" } },
      { slug: "iphone-6", title: "iPhone 6, 6s, Plus", models: ["iPhone 6-6s", "iPhone 6-6s Plus"], tabLabels: { "iPhone 6-6s": "iPhone 6 | 6s", "iPhone 6-6s Plus": "6 Plus | 6s Plus" } },
      { slug: "iphone-5s", title: "iPhone 5, 5s, SE", models: ["iPhone 5s-SE"] },
  ...
  },
  {
    ...
    pages: [
      { slug: "ipad-pro-2024", title: "iPad Pro M4 / M5", models: ["iPad Pro 11 M4", "iPad Pro 13 M4"], tabLabels: { "iPad Pro 11 M4": "iPad Pro 11″", "iPad Pro 13 M4": "Pro 13″" } },
      { slug: "ipad-air-2020", title: "iPad Air / Pro (2018)", models: ["iPad Air 11-inch", "iPad Air 13-inch"], tabLabels: { "iPad Air 11-inch": "10.9″ | 11″", "iPad Air 13-inch": "12.9″ | 13″" } },
      { slug: "ipad-10", title: "Liquid iPad", models: ["iPad 10"] },
      { slug: "ipad-mini-6", title: "Liquid iPad mini", models: ["iPad mini 6"] },
      { slug: "ipad-pro-2020", title: "iPad Pro A12Z / M1 / M2", models: ["iPad Pro 11 M1", "iPad Pro 12.9 M1"], tabLabels: { "iPad Pro 11 M1": "iPad Pro 11″", "iPad Pro 12.9 M1": "Pro 12.9″" } },
      { slug: "ipad-pro-105", title: "iPad 10.2″ & Pro 10.5″", models: ["iPad 10.5"] },
      { slug: "ipad-pro-129", title: "iPad Pro 12.9″", models: ["iPad Pro 12.9 A9X", "iPad Pro 12.9 1-2"] },
      { slug: "ipad-pro-97", title: "iPad Pro 9.7″", models: ["iPad Pro 9.7"] },
      { slug: "ipad-mini-4", title: "iPad mini 4–5", models: ["iPad mini 4", "iPad mini 4-5"] },
      { slug: "ipad-air-2013", title: "iPad Air 1–2 & iPad 5–6", models: ["iPad 9.7", "iPad 9.7 thicc", "iPad Air 2"], tabLabels: { "iPad 9.7 thicc": "iPad Air 1", "iPad Air 2": "iPad Air 2" } },
      { slug: "ipad-mini-2012", title: "iPad Mini 1–3", models: ["iPad mini 1-3"] },
  ...
  },
  {
    slug: "others",
    title: "Others",
    blurb: "AirTag, wallets, MacBook sleeves, and more",
    pages: [
      { slug: "airtag", title: "AirTag", models: ["AirTag"] },
      { slug: "wallet", title: "MagSafe Wallet", models: ["MagSafe iPhone"] },
      { slug: "macbook", title: "MacBook Leather Sleeve", models: ["MacBook 12", "MacBook Pro 13", "MacBook Pro 15", "MacBook Pro 16"], tabLabels: { "MacBook 12": "MacBook 12″", "MacBook Pro 13": "Air & Pro 13″", "MacBook Pro 15": "Pro 15″", "MacBook Pro 16": "Pro 16″" } },
...
export function getHeroCase(page) {
  ...
  return cases.reduce(
    (best, row) =>
      !best || seasonSortKey(row.season) >= seasonSortKey(best.season) ? row : best,
    null,
  );
}
