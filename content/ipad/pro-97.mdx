...
To support the Smart Keyboard connection, Apple had to split the Smart Case in half: it now consisted of a separate Smart Cover and Silicone Case. Sadly, the Smart Keyboard was only available in Black, so it was impossible to colour-match it with fancy cases.
