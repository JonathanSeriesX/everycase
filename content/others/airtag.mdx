...
<CaseTableTabs models={["AirTag"]} material="Silicone Loop" />

### Leather Loop

<CaseTableTabs models={["AirTag"]} material="Leather Loop" />

### Leather Key Ring

<CaseTableTabs models={["AirTag"]} material="Leather Key Ring" />

### FineWoven Key Ring

<CaseTableTabs models={["AirTag"]} material="FineWoven Key Ring" />
